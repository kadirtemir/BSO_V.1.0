...
namespace Otobüs_Bilet_Otomasyonu
{
    public partial class bilet : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Server = 46.1.54.221; Database=otomasyon;User ID = otomasyon; Password=test;Charset=utf8;");
        ...
        private void bilet_Load_1(object sender, EventArgs e)
        {

        }

        private void cmbSeferSec_SelectedValueChanged_1(object sender, EventArgs e)
        {
            koltukkontrol();
            koltukreng();
